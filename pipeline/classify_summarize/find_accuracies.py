...
random_forest.fit(train_vectors, y_train)
rf_prediction = random_forest.predict(test_vectors)
...
lr_prediction = logistic_regression.predict(test_vectors)
lr_accuracy = accuracy_score(y_test, lr_prediction)
print("Logistic Regression Accuracy:", lr_accuracy)

# SVC (Support Vector Classifier)svc = SVC()
svc.fit(train_vectors, y_train)
svc_prediction = svc.predict(test_vectors)
svc_accuracy = accuracy_score(y_test, svc_prediction)
print("SVC Accuracy:", svc_accuracy)

# SGDClassifiersgd_classifier = SGDClassifier()
sgd_classifier.fit(train_vectors, y_train)
sgd_prediction = sgd_classifier.predict(test_vectors)
...
nb_prediction = naive_bayes.predict(test_vectors)
nb_accuracy = accuracy_score(y_test, nb_prediction)
print("Naive Bayes Accuracy:", nb_accuracy)

# Gradient Boosting Classifiergradient_boosting = GradientBoostingClassifier()
gradient_boosting.fit(train_vectors, y_train)
gb_prediction = gradient_boosting.predict(test_vectors)
